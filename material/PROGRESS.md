...
| 15_カリキュラム骨子案 | ドラフト・局長レビュー待ち | パートA〜E構成・体験ゴール・退屈対策（2026-07-24追加） |
...
| 2 | Drive教材の扱い | 取り込みではなく**スタイルの正本**（「一緒に進めてる感」の再現が目的） → 11 §3, 12 §4, 14 Phase 4を訂正済み |
...
- Codex Round 3: 実行待ち（CONSENSUS-READY: YES まで往復継続）
